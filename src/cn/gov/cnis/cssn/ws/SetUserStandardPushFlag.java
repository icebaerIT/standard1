 ...
 */
            ...
            /**
            *  SetUserStandardPushFlag bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetUserStandardPushFlag
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                                    ...
                                    protected java.lang.String[] localPushId ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPushIdTracker = false ;

                           public boolean isPushIdSpecified(){
                               return localPushIdTracker;
                           }
                           ...
                           */
                           public  java.lang.String[] getPushId(){
                              ...
                              /**
                               * validate the array for PushId
                               */
                              protected void validatePushId(java.lang.String[] param){
                              ...
                              * @param param PushId
                              */
                              public void setPushId(java.lang.String[] param){
                              
                                   validatePushId(param);

                               localPushIdTracker = true;
                                      
                                      this.localPushId=param;
                              }
                             ...
                             */
                             public void addPushId(java.lang.String param){
                                   if (localPushId == null){
                                   localPushId = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPushId);
                               list.add(param);
                               this.localPushId =
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setUserStandardPushFlag",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setUserStandardPushFlag",
                ...
                if (localOrgLoginNameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localPushIdTracker){
                             if (localPushId!=null) {
                                   namespace = "http://ws.cssn.cnis.gov.cn";
                                   for (int i = 0;i < localPushId.length;i++){
                                        
                                            if (localPushId[i] != null){
                                        
                                                writeStartElement(null, namespace, "pushId", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPushId[i]));
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://ws.cssn.cnis.gov.cn", "pushId", xmlWriter);
                                  ...
                                  for (int i = 0;i < localPushId.length;i++){
                                         ...
                                         if (localPushId[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn",
                                                                              "pushId"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPushId[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static SetUserStandardPushFlag parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetUserStandardPushFlag object =
                new SetUserStandardPushFlag();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setUserStandardPushFlag".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetUserStandardPushFlag)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list6 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","pushId").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone6){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","pushId").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setPushId((java.lang.String[])
