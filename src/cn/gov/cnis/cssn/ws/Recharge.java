 ...
 */
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localOrgLoginNameTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn",
                                         ...
                                         elementList.add(localMoney==null?null:
    ...
    public static class Factory{
        ...
        */
        public static Recharge parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Recharge object =
                new Recharge();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"recharge".equals(type)){
                                ...
                                return (Recharge)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","money").equals(reader.getName())){
