 ...
 */
            ...
            /**
            *  GetUkeysByUkeyId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetUkeysByUkeyId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getUkeysByUkeyId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getUkeysByUkeyId",
    ...
    public static class Factory{
        ...
        */
        public static GetUkeysByUkeyId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUkeysByUkeyId object =
                new GetUkeysByUkeyId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUkeysByUkeyId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUkeysByUkeyId)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
