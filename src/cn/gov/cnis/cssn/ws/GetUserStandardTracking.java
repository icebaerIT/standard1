 ...
 */
            ...
            /**
            *  GetUserStandardTracking bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetUserStandardTracking
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getUserStandardTracking",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getUserStandardTracking",
    ...
    public static class Factory{
        ...
        */
        public static GetUserStandardTracking parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUserStandardTracking object =
                new GetUserStandardTracking();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUserStandardTracking".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUserStandardTracking)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
