 ...
 */
            ...
            /**
            *  GetQuoteORQuotedStandard bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetQuoteORQuotedStandard
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getQuoteORQuotedStandard",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getQuoteORQuotedStandard",
    ...
    public static class Factory{
        ...
        */
        public static GetQuoteORQuotedStandard parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetQuoteORQuotedStandard object =
                new GetQuoteORQuotedStandard();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getQuoteORQuotedStandard".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetQuoteORQuotedStandard)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
