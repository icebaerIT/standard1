 ...
 */
            ...
            /**
            *  ReplaceStandardAviso bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReplaceStandardAviso
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                                    ...
                                    protected java.lang.String localLastDate ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localLastDateTracker = false ;

                           public boolean isLastDateSpecified(){
                               return localLastDateTracker;
                           }
                           ...
                           */
                           public  java.lang.String getLastDate(){
                            ...
                            /**
                               ...
                               */
                               public void setLastDate(java.lang.String param){
                            localLastDateTracker = true;
                                   
                                            this.localLastDate=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":replaceStandardAviso",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "replaceStandardAviso",
                ...
                if (localOrgLoginNameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localLastDateTracker){
                                    namespace = "http://ws.cssn.cnis.gov.cn";
                                    writeStartElement(null, namespace, "lastDate", xmlWriter);
                                          ...
                                          if (localLastDate==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localLastDate);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localOrgLoginNameTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn",
                                         ...
                                         elementList.add(localLastDate==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLastDate));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static ReplaceStandardAviso parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReplaceStandardAviso object =
                new ReplaceStandardAviso();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"replaceStandardAviso".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReplaceStandardAviso)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","startDate").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","lastDate").equals(reader.getName())){
