 ...
 */
            ...
            /**
            *  GetTopicCategoryOfTree bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTopicCategoryOfTree
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getTopicCategoryOfTree",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getTopicCategoryOfTree",
    ...
    public static class Factory{
        ...
        */
        public static GetTopicCategoryOfTree parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTopicCategoryOfTree object =
                new GetTopicCategoryOfTree();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getTopicCategoryOfTree".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTopicCategoryOfTree)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
