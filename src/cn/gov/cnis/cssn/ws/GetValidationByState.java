 ...
 */
            ...
            /**
            *  GetValidationByState bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetValidationByState
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                        ...
                        /**
                        * field for DisposeState
                        */

                        
                                    protected java.lang.String localDisposeState ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDisposeStateTracker = false ;

                           public boolean isDisposeStateSpecified(){
                               return localDisposeStateTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getDisposeState(){
                               return localDisposeState;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param DisposeState
                               */
                               public void setDisposeState(java.lang.String param){
                            localDisposeStateTracker = true;
                                   
                                            this.localDisposeState=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getValidationByState",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getValidationByState",
                ...
                if (localOrgLoginNameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localDisposeStateTracker){
                                    namespace = "http://ws.cssn.cnis.gov.cn";
                                    writeStartElement(null, namespace, "disposeState", xmlWriter);
                             

                                          if (localDisposeState==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localDisposeState);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localOrgLoginNameTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn",
                                         ...
                                         elementList.add(localUid==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUid));
                                    } if (localDisposeStateTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn",
                                                                      "disposeState"));
                                 
                                         elementList.add(localDisposeState==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDisposeState));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static GetValidationByState parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetValidationByState object =
                new GetValidationByState();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getValidationByState".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetValidationByState)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","uid").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","disposeState").equals(reader.getName())){
