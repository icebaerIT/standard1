        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                                    ...
                                    protected cn.gov.cnis.cssn.ws.Exception localException ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return cn.gov.cnis.cssn.ws.Exception
                           */
                           public  cn.gov.cnis.cssn.ws.Exception getException(){
                            ...
                            /**
                               ...
                               */
                               public void setException(cn.gov.cnis.cssn.ws.Exception param){
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localExceptionTracker){
                                    if (localException==null){
                                        ...
                                        writeStartElement(null, "http://ws.cssn.cnis.gov.cn", "Exception", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localException.serialize(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","Exception"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Exception".equals(type)){
                                ...
                                return (ExceptionE)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","Exception").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setException(cn.gov.cnis.cssn.ws.Exception.Factory.parse(reader));
