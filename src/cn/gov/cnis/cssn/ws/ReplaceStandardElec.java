 ...
 */
            ...
            /**
            *  ReplaceStandardElec bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReplaceStandardElec
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":replaceStandardElec",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "replaceStandardElec",
    ...
    public static class Factory{
        ...
        */
        public static ReplaceStandardElec parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReplaceStandardElec object =
                new ReplaceStandardElec();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"replaceStandardElec".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReplaceStandardElec)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
