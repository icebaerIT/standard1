...
/**
 * GetUserStandardPushListByFlag.java
 *
 ...
 */
            ...
            /**
            *  GetUserStandardPushListByFlag bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetUserStandardPushListByFlag
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                                    ...
                                    protected java.lang.String localPushType ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPushTypeTracker = false ;

                           public boolean isPushTypeSpecified(){
                               return localPushTypeTracker;
                           }
                           ...
                           */
                           public  java.lang.String getPushType(){
                            ...
                            /**
                               ...
                               */
                               public void setPushType(java.lang.String param){
                            localPushTypeTracker = true;
                                   
                                            this.localPushType=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getUserStandardPushListByFlag",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getUserStandardPushListByFlag",
                ...
                if (localOrgLoginNameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localPushTypeTracker){
                                    namespace = "http://ws.cssn.cnis.gov.cn";
                                    writeStartElement(null, namespace, "pushType", xmlWriter);
                             

                                          if (localPushType==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localPushType);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localOrgLoginNameTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn",
                                         ...
                                         elementList.add(localPushType==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPushType));
                                    } if (localBeginDateTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn",
                                                                      "beginDate"));
    ...
    public static class Factory{
        ...
        */
        public static GetUserStandardPushListByFlag parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUserStandardPushListByFlag object =
                new GetUserStandardPushListByFlag();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUserStandardPushListByFlag".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUserStandardPushListByFlag)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","pushType").equals(reader.getName())){
