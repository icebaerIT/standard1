 ...
 */
            ...
            /**
            *  CreateStandardOrder bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                                    ...
                                    protected cn.gov.cnis.cssn.wssort.xsd.ThiOrderWrap localWrap ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return cn.gov.cnis.cssn.wssort.xsd.ThiOrderWrap
                           */
                           public  cn.gov.cnis.cssn.wssort.xsd.ThiOrderWrap getWrap(){
                               return localWrap;
                           }
                            ...
                            /**
                               ...
                               * @param param Wrap
                               */
                               public void setWrap(cn.gov.cnis.cssn.wssort.xsd.ThiOrderWrap param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":createStandardOrder",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "createStandardOrder",
                ...
                if (localOrgLoginNameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localWrap==null){
                                        ...
                                        writeStartElement(null, "http://ws.cssn.cnis.gov.cn", "wrap", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localWrap.serialize(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","wrap"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localOrgLoginNameTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn",
                                    ...
                                    elementList.add(localWrap==null?null:
                                    localWrap);
                                }
    ...
    public static class Factory{
        ...
        */
        public static CreateStandardOrder parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateStandardOrder object =
                new CreateStandardOrder();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"createStandardOrder".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateStandardOrder)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","wrap").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setWrap(cn.gov.cnis.cssn.wssort.xsd.ThiOrderWrap.Factory.parse(reader));
