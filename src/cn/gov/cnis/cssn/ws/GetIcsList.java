 ...
 */
            ...
            /**
            *  GetIcsList bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetIcsList
    ...
    public static class Factory{
        ...
        */
        public static GetIcsList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetIcsList object =
                new GetIcsList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getIcsList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetIcsList)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
