 ...
 */
            ...
            /**
            *  GetStandardAvisoByType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetStandardAvisoByType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getStandardAvisoByType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getStandardAvisoByType",
    ...
    public static class Factory{
        ...
        */
        public static GetStandardAvisoByType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetStandardAvisoByType object =
                new GetStandardAvisoByType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getStandardAvisoByType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetStandardAvisoByType)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
