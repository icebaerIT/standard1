...
/**
 * GetAdoptORAdoptedStandard.java
 *
 ...
 */
            ...
            /**
            *  GetAdoptORAdoptedStandard bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAdoptORAdoptedStandard
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAdoptORAdoptedStandard",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAdoptORAdoptedStandard",
    ...
    public static class Factory{
        ...
        */
        public static GetAdoptORAdoptedStandard parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAdoptORAdoptedStandard object =
                new GetAdoptORAdoptedStandard();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAdoptORAdoptedStandard".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAdoptORAdoptedStandard)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
