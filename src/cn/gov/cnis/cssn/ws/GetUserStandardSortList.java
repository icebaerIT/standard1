 ...
 */
            ...
            /**
            *  GetUserStandardSortList bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetUserStandardSortList
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getUserStandardSortList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getUserStandardSortList",
    ...
    public static class Factory{
        ...
        */
        public static GetUserStandardSortList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUserStandardSortList object =
                new GetUserStandardSortList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUserStandardSortList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUserStandardSortList)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
