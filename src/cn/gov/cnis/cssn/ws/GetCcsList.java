 ...
 */
            ...
            /**
            *  GetCcsList bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCcsList
    ...
    public static class Factory{
        ...
        */
        public static GetCcsList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCcsList object =
                new GetCcsList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getCcsList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCcsList)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
