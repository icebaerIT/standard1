 ...
 */
            ...
            /**
            *  GetElecFileByBefore bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetElecFileByBefore
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getElecFileByBefore",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getElecFileByBefore",
    ...
    public static class Factory{
        ...
        */
        public static GetElecFileByBefore parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetElecFileByBefore object =
                new GetElecFileByBefore();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getElecFileByBefore".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetElecFileByBefore)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
