 ...
 */
            ...
            /**
            *  ValidationValidity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ValidationValidity
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getA100(){
                              ...
                              /**
                               * validate the array for A100
                               */
                              protected void validateA100(java.lang.String[] param){
                             ...
                             */
                             public void addA100(java.lang.String param){
                                   if (localA100 == null){
                                   localA100 = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localA100);
                               list.add(param);
                               this.localA100 =
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":validationValidity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "validationValidity",
                ...
                if (localOrgLoginNameTracker){
                             ...
                             if (localA100!=null) {
                                   namespace = "http://ws.cssn.cnis.gov.cn";
                                   for (int i = 0;i < localA100.length;i++){
                                            ...
                                            if (localA100[i] != null){
                                                ...
                                                writeStartElement(null, namespace, "A100", xmlWriter);
                                                        ...
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localA100[i]));
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://ws.cssn.cnis.gov.cn", "A100", xmlWriter);
                                  ...
                                  for (int i = 0;i < localA100.length;i++){
                                         ...
                                         if (localA100[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn",
                                                                              "A100"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localA100[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static ValidationValidity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidationValidity object =
                new ValidationValidity();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validationValidity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidationValidity)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone6){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://ws.cssn.cnis.gov.cn","A100").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setA100((java.lang.String[])
