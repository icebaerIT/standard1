 ...
 */
            ...
            /**
            *  GetElecFileByDown bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetElecFileByDown
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getElecFileByDown",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getElecFileByDown",
    ...
    public static class Factory{
        ...
        */
        public static GetElecFileByDown parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetElecFileByDown object =
                new GetElecFileByDown();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getElecFileByDown".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetElecFileByDown)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
