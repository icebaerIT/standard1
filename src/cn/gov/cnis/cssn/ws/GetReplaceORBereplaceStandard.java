...
/**
 * GetReplaceORBereplaceStandard.java
 *
 ...
 */
            ...
            /**
            *  GetReplaceORBereplaceStandard bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetReplaceORBereplaceStandard
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getReplaceORBereplaceStandard",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getReplaceORBereplaceStandard",
    ...
    public static class Factory{
        ...
        */
        public static GetReplaceORBereplaceStandard parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetReplaceORBereplaceStandard object =
                new GetReplaceORBereplaceStandard();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getReplaceORBereplaceStandard".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetReplaceORBereplaceStandard)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
