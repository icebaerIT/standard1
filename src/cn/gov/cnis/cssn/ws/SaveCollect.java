 ...
 */
            ...
            /**
            *  SaveCollect bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SaveCollect
    ...
    public static class Factory{
        ...
        */
        public static SaveCollect parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SaveCollect object =
                new SaveCollect();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"saveCollect".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SaveCollect)cn.gov.cnis.cssn.wssort.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
